...
function StudentResetPass() { //  reset page  <+++++++++++------
  ...
  const handleSubmit = async (event) => {
      ...
      try {
        const response = await fetch(`/student/resetPass`, { // Correctly interpolate the URL
          method: 'POST',
          headers: {
        ...
        if (response.ok) {
          ...
          setError(null);
          window.location.href = '/slogin'; // Redirect on success
        } else {
