...
function Complaint() {
      ...
      <div className="max-w-screen-md mx-auto px-4 md:px-20 py-8 text-center"> 
        ...
        <p className=" text-2xl md:text-3xl mb-8">Thanks for your complaint. Your complaint will be solved as soon as possible. Your complaint token number is <b>{localStorage.getItem('token') || "...."}</b>.</p>
